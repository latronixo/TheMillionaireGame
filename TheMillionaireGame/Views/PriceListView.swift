...
struct PriceListView: View {
    ...
    let currentQuestion: Int //данные о последнем правильно отвеченном вопросе получим из вьюмодели или из постоянного хранилища - в зависимости от выбранной реализации
