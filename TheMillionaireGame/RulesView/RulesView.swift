...
private var rulesScrollView: some View {
    ScrollView {
...
private var rulesTitle: some View {
    Text("Rules")
...
private var closeText: some View {

    Text("Close")
        .foregroundColor(Color(red: 0.275, green: 0.655, blue: 0.929))
